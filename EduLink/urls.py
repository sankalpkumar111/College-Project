...
from EduLink import routing

from EduLink.EditResultView import EditResultView

from . import hod_views, staff_views, student_views, views,accountant_views
...
urlpatterns = [
    ...
    path('add-accountant/', hod_views.add_accountant, name='add_accountant'),
    path('manage-accountant/', hod_views.manage_accountant, name='manage_accountant'),
    ...
    path('attendance/percentage/', staff_views.staff_attendance_percentage, name='staff_attendance_percentage'),

    # Accountant
    
     path("accountant/home/", accountant_views.accountant_home, name='accountant_home'),
     path('accountant/create_fee_category/',  accountant_views.create_fee_category, name='create_fee_category'),
     path('accountant/fee_category_list/',  accountant_views.fee_category_list, name='fee_category_list'),
     path('accountant/fee-payment/', accountant_views.receive_fee, name='fee_payment'),
     path('accountant/fee-payment-list/', accountant_views.fee_payment_list, name='fee_payment_list'),
     path('accountant/invoice/', accountant_views.invoice, name='invoice'),
     path('accountant/generate-invoice-pdf/', accountant_views.generate_invoice_pdf, name='generate_invoice_pdf'),
     path('accountant/paid-fee-students/', accountant_views.paid_fee_students,name='paid_fee_students'),
     # path('accountant/fee-reminders/', accountant_views.fee_reminder_list, name='fee_reminder_list'),
   
#     path('accountant/send-fee-reminder/',accountant_views.send_fee_reminder, name='send_fee_reminder'),
    # Student
